    ...
    class ProductInfo extends HTMLElement {
    	...
    	static classes = {
			...
			static selectors = {
			  ...
			  sectionHeading: '.' + ProductInfo.classes.sectionHeading,
			  sectionText: '.' + ProductInfo.classes.sectionText,
      ...
      connectedCallback() {
		    this.mobileWaypoints = new MobileWaypoints(this, ProductInfo.selectors);
		  ...
		  createDesktopSticky () {
		    window.productSticky = this.desktopSticky = new StickySidebar(this.rightColumn, {
		      containerSelector: ProductInfo.selectors.container,
		      innerWrapperSelector: ProductInfo.selectors.rightColumnInner,
		      bottomSpacing: 10,
		      topSpacing: function() {
